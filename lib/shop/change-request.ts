/**
 * @module lib/shop/change-request
 *
 * 盆栽園変更リクエストの純粋型・Zod schema・parser。
 * 副作用を持たないため Server Action / Server Component 双方から
 * dependency-neutral に import 可能（`lib/prisma/shared-includes.ts` と同方針）。
 */
