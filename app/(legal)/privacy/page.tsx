...
export default function PrivacyPage() {
  return (
    ...
    <div className="prose prose-neutral dark:prose-invert max-w-none">
      ...
      <ul>
        <li><strong>Google AdSense</strong>: Googleが提供する広告配信サービスです。Google AdSenseはCookieを使用して、ユーザーの過去のアクセス情報に基づいたパーソナライズ広告を配信することがあります。</li>
        <li><strong>パーソナライズ広告の無効化</strong>: Googleの<a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="underline hover:text-foreground">広告設定ページ</a>から、パーソナライズ広告を無効にすることができます。</li>
        <li><strong>Cookie同意</strong>: 初回訪問時に表示されるCookie同意バナーで「必要最小限のみ」を選択した場合、パーソナライズ広告やアクセス分析用のCookieは使用されません。</li>
      </ul>
