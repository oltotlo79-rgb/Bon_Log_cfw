/**
 * @module app/api/v1/analytics/keywords
 * GET /api/v1/analytics/keywords — 期間内の投稿キーワード分析データを取得する
 *
...
import { fetchKeywordAnalytics } from '@/lib/services/analytics-service'
...
export async function GET(request: NextRequest) {
  ...
  const data = await fetchKeywordAnalytics(auth.userId, daysNum)
