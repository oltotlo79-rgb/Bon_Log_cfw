/**
 * @module app/api/v1/analytics/follower-growth
 * GET /api/v1/analytics/follower-growth — 期間内のフォロワー増加推移を取得する
 *
...
import { fetchFollowerGrowth } from '@/lib/services/analytics-service'
...
export async function GET(request: NextRequest) {
  ...
  const data = await fetchFollowerGrowth(auth.userId, daysNum)
