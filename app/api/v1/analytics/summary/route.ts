 ...
 * GET /api/v1/analytics/summary — 自分の投稿分析サマリを取得する
 *
...
import { fetchAnalyticsSummary } from '@/lib/services/analytics-read-service'
...
export async function GET(request: NextRequest) {
  ...
  // 6. 集計クエリ実行
  const summary = await fetchAnalyticsSummary(auth.userId, daysNum)
