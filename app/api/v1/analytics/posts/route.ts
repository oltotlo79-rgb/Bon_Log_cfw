/**
 * @module app/api/v1/analytics/posts
 * GET /api/v1/analytics/posts — 期間内の投稿分析データを取得する
 *
...
import { fetchPostAnalytics } from '@/lib/services/analytics-service'
...
export async function GET(request: NextRequest) {
  ...
  // 6. 集計クエリ実行
  const data = await fetchPostAnalytics(auth.userId, daysNum)
