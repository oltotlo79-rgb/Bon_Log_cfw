/**
 * @module app/api/v1/analytics/period-comparison
 * GET /api/v1/analytics/period-comparison — 現期間と前期間の比較データを取得する
 *
...
import { fetchPeriodComparison } from '@/lib/services/analytics-service'
...
export async function GET(request: NextRequest) {
  ...
  const data = await fetchPeriodComparison(auth.userId, daysNum)
