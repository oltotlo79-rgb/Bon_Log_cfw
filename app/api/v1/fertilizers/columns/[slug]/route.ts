/**
 * @module app/api/v1/fertilizers/columns/[slug]
...
import { slugQuerySchema, getFertilizerColumnBySlug } from '@/lib/services/fertilizer-read-service'
...
export async function GET(
  ...
  const item = await getFertilizerColumnBySlug(parsed.data)
