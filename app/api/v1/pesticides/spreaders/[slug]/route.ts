/**
 * @module app/api/v1/pesticides/spreaders/[slug]
 * GET /api/v1/pesticides/spreaders/{slug} — 展着剤タイプ詳細
 *
 * ゲスト可（認証任意）。不存在時は 404。
 */
...
import { z } from 'zod'
import { getSpreaderTypeBySlug } from '@/lib/services/pesticide-read-service'
...
export async function GET(
  ...
  // 4. 詳細取得
  const item = await getSpreaderTypeBySlug(parsed.data)
