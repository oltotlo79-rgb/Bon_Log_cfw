/**
 * @module app/api/v1/pesticides/ingredients/[slug]
...
import { z } from 'zod'
import { getActiveIngredientBySlug } from '@/lib/services/pesticide-read-service'
...
export async function GET(
  ...
  // 4. 詳細取得
  const item = await getActiveIngredientBySlug(parsed.data)
