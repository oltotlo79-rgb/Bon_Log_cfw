/**
 * @module app/api/v1/pesticides/disease-pests/[slug]
...
import { z } from 'zod'
import { getDiseasePestBySlug } from '@/lib/services/pesticide-read-service'
...
export async function GET(
  ...
  // 4. 詳細取得
  const item = await getDiseasePestBySlug(parsed.data)
